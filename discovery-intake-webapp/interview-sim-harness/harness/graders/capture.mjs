...
export function gradeCapture(result, persona) {
  ...
  return {
    ...
    recall: round(matched.length / Math.max(1, expected.length), 3),
    precision: round(precise.length / Math.max(1, capturedItems.length), 3),
